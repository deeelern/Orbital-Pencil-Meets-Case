      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {userProfile.photos?.length > 0 && (
          <View style={styles.photosSection}>
            ...
            <TouchableOpacity onPress={handleEditPictures} style={styles.actionBtn}>
        ...
        <View style={styles.infoSection}>
          ...
          <TouchableOpacity onPress={handleEditProfile} style={styles.actionBtn}>
            <Ionicons name="pencil-outline" size={16} color="#6C5CE7" />
            <Text style={styles.actionText}>Edit Profile</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={handleEditPreferences} style={styles.actionBtn}>
        ...
        <View style={styles.detailsSection}>
          {userProfile.heightCm && (
            <Text style={styles.detailText}>Height: {userProfile.heightCm} cm</Text>
          )}
          {userProfile.jobTitle && (
            <Text style={styles.detailText}>Job: {userProfile.jobTitle}</Text>
          )}
          {userProfile.religion && (
            <Text style={styles.detailText}>Religion: {userProfile.religion}</Text>
          )}
        </View>
