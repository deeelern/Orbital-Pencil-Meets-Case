...
function ModernRadio({ label, selected, onPress, icon }) {
  return (
    <TouchableOpacity 
      style={[styles.modernRadioContainer, selected && styles.modernRadioSelected]} 
      onPress={onPress}
      activeOpacity={0.7}
    >
      <View style={styles.modernRadioContent}>
        {icon && <Ionicons name={icon} size={20} color={selected ? '#6C5CE7' : '#74b9ff'} style={styles.radioIcon} />}
        <Text style={[styles.modernRadioLabel, selected && styles.modernRadioLabelSelected]}>
          {label}
        </Text>
      </View>
      <View style={[styles.modernRadioButton, selected && styles.modernRadioButtonSelected]}>
  ...
  return (
    <View style={styles.sectionHeader}>
      <View style={styles.sectionTitleRow}>
        {icon && <Ionicons name={icon} size={24} color="#6C5CE7" style={styles.sectionIcon} />}
...
export default function ProfileSetupScreen({ navigation, route }) {
  ...
  const ethnicities = ['Asian','Black/African','Hispanic/Latino','Middle Eastern','White','Indigenous','Other'];
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            <SectionHeader 
              ...
              icon="calendar"
            />
            <TouchableOpacity style={styles.modernDateBtn} onPress={() => setShowDobPicker(true)}>
              <Ionicons name="calendar-outline" size={20} color="#6C5CE7" />
              <Text style={styles.modernDateText}>{dob.toLocaleDateString()}</Text>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.inputGroup}>
              <View style={styles.modernInputContainer}>
                <Ionicons name="person-outline" size={20} color="#74b9ff" style={styles.inputIcon} />
                <TextInput 
          ...
          <View style={styles.section}>
            ...
            {myGender === 'Other' && (
              <View style={styles.modernInputContainer}>
                <Ionicons name="create-outline" size={20} color="#74b9ff" style={styles.inputIcon} />
                <TextInput 
          ...
          <View style={styles.section}>
            ...
            <View style={styles.modernInputContainer}>
              <Ionicons name="library-outline" size={20} color="#74b9ff" style={styles.inputIcon} />
              <TextInput 
                placeholder="e.g. NUS" 
                style={styles.modernInput} 
                value={school} 
          ...
          <View style={styles.section}>
            ...
            <View style={styles.modernInputContainer}>
              <Ionicons name="briefcase-outline" size={20} color="#74b9ff" style={styles.inputIcon} />
              <TextInput 
          ...
          <View style={styles.section}>
            ...
            {showHeightPicker && (
              <View style={{ backgroundColor: '#fff', borderRadius: 12, marginTop: 12 }}>
                <Picker 
